 ...
 *
 * To enable these state events, include the `stateEvents.plugin` file in your project, e.g.,
 * ```
 * <script src="stateEvents.plugin"></script>
 * ```
...
//# sourceMappingURL=stateEvents.plugin.map
